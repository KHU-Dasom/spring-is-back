    ...
    while (true) {
        ...
        while (currentUser != null) {
            ...
            while (currentTaskList != null) {
                ...
                println("1. Task 생성\t2. 일정 Task 생성\t3. Task 삭제\t4. TodoList 변경")
                println("5. Task 상태 변경\t6. Task 정렬 변경\t7. 로그아웃")
                when (input().toInt()) {
                    ...
                    6 -> {
                        println("목록 정렬(e.g. TASK | DUE | STATUS")
                        currentTaskList.sortTaskList(input("기준: "))
                    }
                    7 -> {
                        currentUser = null
                        currentTaskList = null
